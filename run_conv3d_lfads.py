...
from objective import Conv_LFADS_Loss
...
def main():
    ...
    objective = Conv_LFADS_Loss(loss_weight_dict={'kl_obs': hyperparams['objective']['kl_obs'],
                                                  'l2': hyperparams['objective']['l2']},
                                                  l2_con_scale= hyperparams['objective']['l2_con_scale'],
                                                  l2_gen_scale= hyperparams['objective']['l2_gen_scale']).to(device)
    
    model = Conv3d_LFADS_Net(channel_dims    = hyperparams['model']['channel_dims'],
